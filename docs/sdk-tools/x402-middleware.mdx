...
description: "Gate your API routes behind USDC micropayments using Google's AP2 protocol alongside multi-protocol discovery — CDP Bazaar, MPPScan, and Delegare AP2 mandates."
---
