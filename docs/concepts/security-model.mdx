...
The private key is stored in **AWS Secrets Manager**, encrypted at rest, and scoped to the individual mandate. It is:
- **Not accessible to Delegare staff** — Secrets Manager access is audit-logged and restricted by IAM policy.
...
| **Session key storage** | AWS Secrets Manager | AES-256 encryption at rest, IAM-scoped, audit-logged |
