...
A **Intent Mandate** is a cryptographically secured authorization that allows an agent to spend up to a certain amount on behalf of a user.
...
- **Issuance:** A signed `intentMandate` is generated.
